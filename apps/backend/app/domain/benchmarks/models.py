"""Parser benchmark contracts and validation helpers."""
...
from app.domain.pipeline import PipelineOption
    ...
    *,
    ...
    if field_name == "completed_postflop_streets":
        ...
        for item in value:
            ...
            try:
                normalized = CompletedPostflopStreetHistory.model_validate(item).model_dump(
                    mode="json"
                )
            except ValidationError as exc:
                raise ValueError(

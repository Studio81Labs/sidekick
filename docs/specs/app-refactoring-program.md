...
| 12   | In progress | All frontend shared endpoint facades are removed and MCP writes use commands; peer-feature allowlists, backend compatibility modules, release audits, and final documentation remain                 |

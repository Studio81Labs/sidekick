...
compatibility surfaces. The MCP transport owner, peer-feature exceptions,
...
| 12   | In progress | The frontend shared-type barrel and client/jobs/history/benchmark/training/system API facades are removed; MCP transport, peer-feature allowlists, backend facades, release audits, and final docs remain |

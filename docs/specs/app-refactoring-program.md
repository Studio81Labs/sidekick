...
jobs/history, and benchmark facades have been retired, and architecture checks
prevent production code from recreating or importing those compatibility
surfaces. Remaining endpoint facades, peer-feature exceptions, backend
...
| 12   | In progress | The frontend shared-type barrel and client/jobs/history/benchmark API facades are removed; endpoint facades, peer-feature allowlists, backend compatibility modules, release audits, and final docs remain |

...
Status: R0a complete; source qualification deferred by ADR 0082
...
The owner approved the review-first reshape in #525 and [ADR 0082](../decisions/0082-deliver-a-review-first-local-mvp.md).
#412 R0/R1–R4 and the remaining teaching loop are deferred, not completed. No
source is qualified. The review MVP does not require solver exports, convergence,
reference rights or a solver budget. This report preserves the source evidence
and future qualification requirements; it does not instruct another R0a pass.

## Recommendation for future learning re-entry
...
records the owner-approved review-first reshape in ADR 0082; it approves no
screened candidate or narrower solved game.

### R0a execution and exit (completed; historical instructions)
...
R0a is complete with no eligible current-floor source. #525 is resolved by the
review-first scope decision in ADR 0082. Do not repeat screening, start
R0/R1–R4, run/build a solver or restore a removed provider. #412 is deferred under
#406 and is not a #405/#414 review-release dependency.

Future learning re-entry requires an explicit owner decision and newly evidenced
eligible no-fee source route. Freeze exact artifact/units/convergence, independent
verification, applicable rights and feasible local resources before R0/R1–R4.
Review-pilot acceptance does not substitute for the future learning-specific
coverage or positive-origin evidence. No paid supplier/trial is pending and no
complete source or independent poker certification has been obtained.

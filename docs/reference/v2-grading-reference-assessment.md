...
- The current
  ...
  convergence evidence. The scorer still uses `ev_bb`, and declarations or
  evidence pointers do not themselves prove ownership, input completeness,
  delivery rights, or correct matching of a case to the declared coverage.
